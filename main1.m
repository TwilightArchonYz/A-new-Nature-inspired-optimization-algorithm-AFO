%% 2020.11.30 帝企鹅算法  平移后的标准测试函数
% 帝企鹅算法在平移后的标准测试函数上的实验
...
option.maxIteration=50;    %最大迭代次数 maximum number of interation
% 帝企鹅算法
...
%% 绘制函数图像 Plotting function images
option.F=['F',num2str(option.no)];
figure
func_plot(option.F)
